			...
			<div className="mb-4">
				...
				<div className="mt-2 flex items-center text-xs gap-4">
					{['Any', 'Family', 'Bachelor (Men)', 'Bachelor (Women)'].map(preference => (
						<label
							key={preference}
							className={`inline-flex items-center border-2 p-2 rounded-full ${selectedTenantPreference === preference ? 'bg-blue-500 text-white' : ''
								}`}
						>
							<input
								type="radio"
			...
			<div className="mb-4">
				...
				<div className="mt-2 flex items-center text-xs gap-4">
					{['Immediate', 'within 15 days', 'within 1 month', 'within 2 months'].map(availability => (
						<label
							key={availability}
							className={`inline-flex items-center border-2 p-2 rounded-full ${selectedAvailability === availability ? 'bg-blue-500 text-white' : ''
								}`}
						>
							<input
								type="radio"
