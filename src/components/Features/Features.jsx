...
const Features = () => {
	...
	return (
		<form className="space-y-4 p-4">
			...
			<div className="border-b p-4 rounded">
				<h2 className="text-lg font-medium my-4"> <span className='text-red-500 text-sm'>*</span> Safety</h2>
				<div className=" grid grid-cols-2 items-center ">
					{["24/7 Security personnel (Gated Security)","Security Systems- CCTV"].map((tile) => (
						<label key={tile} className="flex gap-2 items-center">
							<input
								type="checkbox"
								name="tiles"
			...
			<div className="border-b p-4 rounded">
				<h2 className="text-lg font-medium my-4"> SOCIETY AMENITIES</h2>
